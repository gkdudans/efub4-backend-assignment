...
public class AuthService {
    ...
    public TokenResponseDto reissueAccessToken(String refreshToken) {
        // 전달받은 리프레시 토큰에서 kakaoID를 추출하여 사용자 정보 가져오기
        Long kakaoId = tokenProvider.extractKakaoID(refreshToken);
        Member member = getUserByKakaoId(kakaoId);
    ...
    public Member getUserByKakaoId(Long kakaoId) {
